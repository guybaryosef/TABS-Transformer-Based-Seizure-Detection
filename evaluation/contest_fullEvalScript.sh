...
## fullEvalScript.sh - runs through the hoops to evaluate a model's outputs.
##
...
./contest_evaluateModelOutputsScript.sh ${model_output_dir} ${pp_output_dir_name} ${threshold}
